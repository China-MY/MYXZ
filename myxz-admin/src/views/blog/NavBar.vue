<template>
    <el-header :style="'margin-bottom:' + headerBottom + 'px'">
        <h2 class="logo"><svg-icon icon-class="EarOfWheat" /> 明裕学长博客</h2>
        <div class="bg-purple-light">
            <el-menu :default-active="activeIndex" router class="el-menu-demo" mode="horizontal" style="border: none;"
                ...
                <el-menu-item index="/blog/main/blogIndex"><i class="el-icon-s-home"
        ...
        <div class="bg-purple-light el-menu-hidden" v-if="menuHiddenVisiable">
            <el-menu :default-active="activeIndex" router background-color="rgba(84,92,100,0.5)" text-color="#fff"
                ...
                <el-menu-item index="/blog/main/blogIndex" @click="menuAway"><i class="el-icon-s-home"
    ...
    data() {
        return {
            ...
            menulist: [{
                id: 1,
                authName: '随笔',
                path: '/blog/main/essay',
                icon: 'el-icon-edit',
            },
            {
                id: 2,
                authName: '留言',
                path: '/blog/main/message',
        ...
        async logout() {
            this.$confirm('确定注销并退出系统登录吗？', '提示', {
                ...
                this.$store.dispatch('LogOut').then(() => {
                    location.href = '/blog/main/cmsIndex';
                })
            }).catch(() => { });
        }
    }
